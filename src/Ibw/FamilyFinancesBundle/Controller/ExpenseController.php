...
use Ibw\FamilyFinancesBundle\Entity\Expense;
use Ibw\FamilyFinancesBundle\Form\ExpenseType;
...
class ExpenseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IbwFamilyFinancesBundle:Expense')->findAll();

        return $this->render('IbwFamilyFinancesBundle:Expense:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('IbwFamilyFinancesBundle:Expense:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IbwFamilyFinancesBundle:Expense')->find($id);
        ...
        return $this->render('IbwFamilyFinancesBundle:Expense:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('IbwFamilyFinancesBundle:Expense:edit.html.twig', array(
            'entity'      => $entity,
